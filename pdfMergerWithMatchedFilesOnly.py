#This module will pick files from two different directories and pick the first page from corresponding PDF files 
# For example : file names Org0001_*pg1 and Org0001_*pg3 are treated as corresponding file. First page of each of these files is merged in to 
...
# Those file names are listed as unmatched file.
...
# Driver code
    ...
    for files in listOfPdfFiles_1:
      for file in files:
        print("----------------------------------------")
        print(file)  
        page1 = retFirstPageOfPdf(file, 0)
